 ...
 */
public class Check {
	//private static final String POST_URL = "https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token=" + AuthService.getAuth("FXDc8nBvU9VQCmLnkzxQT3DA","WD0eb311npPp6F9nrOBNHx89KG4uc4hj");
	private static final String POST_URL = "https://aip.baidubce.com/rest/2.0/solution/v1/iocr/recognise?access_token=" + AuthService.getAuth("FXDc8nBvU9VQCmLnkzxQT3DA","WD0eb311npPp6F9nrOBNHx89KG4uc4hj");
    ...
    public static String checkFile(String path) throws URISyntaxException, IOException {
        ...
        String param = "image=" + URLEncoder.encode(imgStr, "UTF-8")+"&templateSign=8252eb99ffe97de68b7664f718efa43c";
        //String image = BaseImg64.getImageStrFromPath(path);
        //String param = "image=" + image+"&templateSign=8252eb99ffe97de68b7664f718efa43c";
        return post(param);
    }
